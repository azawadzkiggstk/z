...
export function overrideBlockType(name, metadata, settings) {
  addFilter('blocks.registerBlockType', `statik/override/${name}`, (defaultSettings, defaultName, deprecation) => {
    ...
    const mergedSettings = merge({}, defaultSettings, metadata, settings);
