...
import alignLeft from './assets/align-left';
import alignRight from './assets/align-right';
import alignCenter from './assets/align-center';
import tableColumnAfter from './assets/table-column-after';
import tableColumnBefore from './assets/table-column-before';
import tableColumnDelete from './assets/table-column-delete';
import tableRowAfter from './assets/table-row-after';
import tableRowBefore from './assets/table-row-before';
import tableRowDelete from './assets/table-row-delete';
