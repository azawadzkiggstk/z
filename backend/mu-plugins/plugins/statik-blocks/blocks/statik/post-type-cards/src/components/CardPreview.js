...
export function CardPreview() {
	...
	const className = clsx(
		'wp-block-statik-post-type-cards__card',
		'wp-block-statik-post-type-cards__card--preview'
	);
	...
	return (
		<div className={ className }>
			...
			{ displayTitle && (
				<h3 className="wp-block-statik-post-type-cards__title">
					<Skeleton.Inline>Sample title</Skeleton.Inline>
				</h3>
			) }
			{ displayExcerpt && (
				<div className="wp-block-statik-post-type-cards__excerpt">
					<Skeleton.Text tag="p">
